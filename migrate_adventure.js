...
// Since I might not have 'uuid' package available for a quick script, 
// I'll use a simple crypto-based UUID generator or just a placeholder for now.
const generateUUID = () => {
...
const filePath = path.join(__dirname, 'test_adventure.json');
