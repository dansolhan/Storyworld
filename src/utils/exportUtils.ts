 ...
 */
export const exportToJson = (data: Page[], filename = 'game_data.json') => {
 ...
 */
export const exportToStoryworld = (data: Page[], filename = 'game_data.storyworld') => {
 ...
 */
export const parseFromStoryworld = (base64String: string): Page[] => {
  try {
