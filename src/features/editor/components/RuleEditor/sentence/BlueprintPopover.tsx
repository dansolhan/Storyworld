      ...
      case 'message':
        return (
          <MessageInput
            value={inputValue}
            onChange={setInputValue}
            title="What the reader is told:"
            placeholder="Shown on the next page…"
            onSave={(val) => {
      ...
      case 'text':
        return (
          <MessageInput
            value={inputValue}
            onChange={setInputValue}
            title="The choice’s new wording:"
            placeholder="How the choice should read…"
            onSave={(val) => {
              onChangeParam('text', val);
              onClose();
            }}
          />
        );
